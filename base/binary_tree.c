...
static genc_bt_node_head_t* genc_bt_rightmost_in_subtree(genc_bt_node_head_t* subtree) __attribute__ ((no_instrument_function));
static genc_bt_node_head_t* genc_bt_leftmost_in_subtree(genc_bt_node_head_t* subtree) __attribute__ ((no_instrument_function));
