...
static z_crc_t crc32_combine_(z_crc_t crc1, z_crc_t crc2, uint32_t len2);
...
#ifdef MAKECRCH
    /* write out CRC tables to crc32_table.h */
    {
        FILE *out;
...
/* ========================================================================= */
static z_crc_t crc32_combine_(crc1, crc2, len2)
    z_crc_t crc1;
    z_crc_t crc2;
    uint32_t len2;
{
