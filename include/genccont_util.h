...
static GENC_INLINE void* genc_container_of_helper(void* obj, ptrdiff_t offset) __attribute__ ((no_instrument_function));
static GENC_INLINE void* genc_container_of_notnull_helper(void* obj, ptrdiff_t offset) __attribute__ ((no_instrument_function));

#if __GNUC__
	/* GNU C has some builtin trickery that is almost as good as overloading */
	/* function for avoiding multiple evaluation */
	static GENC_INLINE const void* genc_container_of_const_helper(const void* obj, ptrdiff_t offset) __attribute__ ((no_instrument_function));
	static GENC_INLINE const void* genc_container_of_const_notnull_helper(const void* obj, ptrdiff_t offset) __attribute__ ((no_instrument_function));
#endif
