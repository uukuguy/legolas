...
void genc_dlist_init(struct dlist_head* head) __attribute__ ((no_instrument_function));

/* Sets the list membership head to all NULLs (not part of a list) */
void genc_dlist_head_zero(struct dlist_head* head) __attribute__ ((no_instrument_function));

/* Returns true if the list head is cleared to NULLs (not part of a list) */
bool genc_dlist_is_null(genc_dlist_head_t* head) __attribute__ ((no_instrument_function));
 ...
 */
struct dlist_head* genc_dlist_find_in_range(struct dlist_head* start_after, struct dlist_head* end_before, genc_dlist_entry_pred_fn pred, void* data) __attribute__ ((no_instrument_function));
 ...
 */
struct dlist_head* genc_dlist_find_in_list(struct dlist_head* list, genc_dlist_entry_pred_fn pred, void* data) __attribute__ ((no_instrument_function));
 ...
 */
void genc_dlist_insert_before(struct dlist_head* new_entry, struct dlist_head* before) __attribute__ ((no_instrument_function));
 ...
 */
void genc_dlist_insert_after(struct dlist_head* new_entry, struct dlist_head* after) __attribute__ ((no_instrument_function));

/** Removes the list element at the given position and returns it
 */
struct dlist_head* genc_dlist_remove(struct dlist_head* entry) __attribute__ ((no_instrument_function));
 ...
 * false is returned. */
bool genc_dlist_remove_if_not_null(genc_dlist_head_t* item) __attribute__ ((no_instrument_function));

/** Returns 0 if the list contains elements, non-zero (1) if empty 
 */
int genc_dlist_is_empty(struct dlist_head* list) __attribute__ ((no_instrument_function));

/** Removes the list element at the end of the given list, or NULL if the list is empty
 */
struct dlist_head* genc_dlist_remove_last(struct dlist_head* list) __attribute__ ((no_instrument_function));

/** Removes the list element at the start of the given list, or NULL if the list is empty
 */
struct dlist_head* genc_dlist_remove_first(struct dlist_head* list) __attribute__ ((no_instrument_function));


/** Returns the last entry in the given list, or NULL if the list is empty */
struct dlist_head* genc_dlist_last(struct dlist_head* list) __attribute__ ((no_instrument_function));

/** Number of elements in the list, NOT including the head element. */
size_t genc_dlist_length(struct dlist_head* list) __attribute__ ((no_instrument_function));
...
void genc_dlist_splice(
	genc_dlist_head_t* into_after, genc_dlist_head_t* from_after, genc_dlist_head_t* from_before) __attribute__ ((no_instrument_function));
...
void genc_dlist_splice_before(
	genc_dlist_head_t* into_before, genc_dlist_head_t* from_after, genc_dlist_head_t* from_before) __attribute__ ((no_instrument_function));

void genc_assert_dlist_is_healthy(genc_dlist_head_t* list) __attribute__ ((no_instrument_function));
