...
void genc_binary_tree_init(genc_binary_tree_t* tree, genc_binary_tree_less_fn less_fn, void* less_fn_opaque) __attribute__ ((no_instrument_function));
...
genc_bool_t genc_bt_insert(genc_binary_tree_t* tree, genc_bt_node_head_t* item) __attribute__ ((no_instrument_function));
/* Remove the given item from the tree. */
void genc_bt_remove(genc_binary_tree_t* tree, genc_bt_node_head_t* item) __attribute__ ((no_instrument_function));
 ...
 * */
genc_bt_node_head_t** genc_bt_find_insertion_point(genc_binary_tree_t* tree, genc_bt_node_head_t* item, genc_bt_node_head_t** out_parent) __attribute__ ((no_instrument_function));
/* Returns the tree node equal to item, or NULL if no such node exists. */
genc_bt_node_head_t* genc_bt_find(genc_binary_tree_t* tree, genc_bt_node_head_t* item) __attribute__ ((no_instrument_function));
...
genc_bt_node_head_t* genc_bt_find_or_lower(genc_binary_tree_t* tree, genc_bt_node_head_t* item) __attribute__ ((no_instrument_function)); 
/* Tries to find a node in the tree with the smallest key greater than or equal to
 * item's. If the tree contains no such node, NULL is returned. */
genc_bt_node_head_t* genc_bt_find_or_higher(genc_binary_tree_t* tree, genc_bt_node_head_t* item) __attribute__ ((no_instrument_function));

/*genc_bt_node_head_t* genc_bt_find_or_higher(genc_binary_tree_t* tree, genc_bt_node_head_t* item);*/
genc_bt_node_head_t* genc_bt_first_item(genc_binary_tree_t* tree) __attribute__ ((no_instrument_function));
genc_bt_node_head_t* genc_bt_next_item(genc_binary_tree_t* tree, genc_bt_node_head_t* after_item) __attribute__ ((no_instrument_function));
genc_bt_node_head_t* genc_bt_last_item(genc_binary_tree_t* tree) __attribute__ ((no_instrument_function));
genc_bt_node_head_t* genc_bt_prev_item(genc_binary_tree_t* tree, genc_bt_node_head_t* before_item) __attribute__ ((no_instrument_function));

void genc_bt_swap_trees(genc_binary_tree_t* tree_a, genc_binary_tree_t* tree_b);
genc_bool_t genc_bt_is_empty(genc_binary_tree_t* tree) __attribute__ ((no_instrument_function));
